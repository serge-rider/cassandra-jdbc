...
public class JdbcAscii extends AbstractJdbcType<String> {
    ...
    {
        try {
            return CassandraUtils.string(bytes, CassandraUtils.US_ASCII);
        } catch (CharacterCodingException e) {
            throw new MarshalException("Invalid ascii bytes " + CassandraUtils.bytesToHex(bytes));
        }
    }
    ...
    {
        return CassandraUtils.bytes(value, CassandraUtils.US_ASCII);
    }
}
