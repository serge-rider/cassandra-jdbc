...
public class DataSourceIT
{
    ...
    /*
     * these tests don't compile anymore because Cassandra DataSource is gone
    ...
    public void testConstructor() throws Exception
    {
        ...
        assertFalse(cnx.isClosed());
        ds.setLoginTimeout(5);
        assertEquals("2.0.0", ((CassandraConnection) cnx).getConnectionProps().get(Utils.PROP_CQL_VERSION));
        assertEquals(5, ds.getLoginTimeout());
    }
    ...
    @TestMetadata(expected=SQLFeatureNotSupportedException.class)
